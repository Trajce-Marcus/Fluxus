...
const WORKSPACE_ITEMS: { id: ActivityItem; label: string; path: string }[] = [
  { id: 'workspace', label: 'Workspace', path: ICON.workspace },
];
...
function ActivityBarComponent() {
  const { activeActivityItem, solutionId } = useShellState(['activeActivityItem', 'solutionId']);
